...
| 标注 | 已实现基础版 | `EditingTool` / `ImageEditingSession` | 画笔、荧光笔、矩形、圆形、箭头、文字、马赛克、裁剪 |
| 贴图 | 已实现基础版 | `FloatingWindowController` / 编辑窗口 | 截图可置顶参考，支持多窗口管理 |
...
4. 数字序号标注尚未单独建模；可以用文字工具完成，但体验不如 iShot 的序号工具。
