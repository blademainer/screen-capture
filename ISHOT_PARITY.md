...
| 多窗口截图 | 已实现 | `captureMultipleWindowsScreenshot()` / `MultiWindowSelectionView` / `HotKeyAction.multiWindowScreenshot` | 自绘窗口多选覆盖层，点击选择多个窗口后按 Enter 合成；默认 `⌘⌥W` 触发，桌面底板模式可在设置中关闭 |
